...
// TaskWaitCommand is a cli.Command implementation for scaling the db of a project.
type TaskWaitCommand struct {
	Meta
	flagSet *flag.FlagSet
}

// Run is part of cli.Command implementation.
func (c *TaskWaitCommand) Run(args []string) int {
...
func (c *TaskWaitCommand) Synopsis() string {
	return "Wait on the status of a task"
}

// Help is part of cli.Command implementation.
func (c *TaskWaitCommand) Help() string {
	helpText := `
usage: sqsc task wait [options] <task-id>

  Wait on the status of a task.
