...
require (
	...
	github.com/bgentry/actioncable-go v0.0.0-20170309201021-1f2dbd93dbae
	github.com/bgentry/speakeasy v0.0.0-20160813190634-a1ccbf2c40df
	github.com/briandowns/spinner v0.0.0-20160718203027-a00ac22c7462
	github.com/fatih/color v1.0.1-0.20160927154850-0016e2689083
